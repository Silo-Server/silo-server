...
seen = {}
for r in rows:
    if r["listener"] == "operational_debug":
        continue  # The Go gate separately validates the finite profiling exclusion.
    k = key(r)
    seen[k] = seen.get(k, 0)
