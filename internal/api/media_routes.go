...
var nativeMediaRoutes = []streamtelemetry.MediaRoute{
	nativeRoute(http.MethodGet, "/api/v2/catalog/items/{owner_id}/themes/{theme_id}/audio", streamtelemetry.ClassTransfer, false),
	nativeRoute(http.MethodHead, "/api/v2/catalog/items/{owner_id}/themes/{theme_id}/audio", streamtelemetry.ClassTransfer, false),
