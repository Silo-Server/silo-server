...
const redetectAdminEpisodeIntroOperation = "redetectAdminEpisodeIntro"

func registerAdminCatalogIntro(reg *Registry) {
	for _, action := range []struct{ suffix, id, action string }{
		{"refresh-markers", "refreshAdminEpisodeMarkers", "refresh-v2"}, {"redetect-intro", redetectAdminEpisodeIntroOperation, "redetect"},
	} {
