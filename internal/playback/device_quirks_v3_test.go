...
func TestDeviceQuirkProtocolAcceptsEitherFeatureLocation(t *testing.T) {
	...
	req.ClientPlaybackContext.Features = []string{FeaturePlaybackPlanV3, FeatureDetailedDecodeV3}
	...
	contextOnly.ClientFeatures = []string{FeaturePlaybackPlanV3, FeatureDetailedDecodeV3}
	...
	neither.ClientFeatures = []string{FeaturePlaybackPlanV3}
