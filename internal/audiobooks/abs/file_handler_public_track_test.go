...
func (f *filesMediaStore) GetItemType(ctx context.Context, contentID string, access catalog.AccessFilter) (string, error) {
	return itemTypeFromLookup(f.GetAudiobookByID(ctx, contentID, access))
}
