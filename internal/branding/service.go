...
// defaults instead of serving broken images. Returns how many were cleared.
func (s *Service) ReconcileMissingAssets(ctx context.Context) (cleared int, err error) {
