...
export const v2Operations = {
  ...
  "GET /api/v2/catalog/items/{id}/themes/{theme_id}/audio": "getThemeSongAudio",
  ...
  "GET /api/v2/catalog/themes/capabilities": "getThemeSongsCapability",
  ...
  "HEAD /api/v2/catalog/items/{id}/themes/{theme_id}/audio": "headThemeSongAudio",
  ...
  "POST /api/v2/catalog/items/{id}/themes/{theme_id}/playback": "createThemeSongPlayback",
