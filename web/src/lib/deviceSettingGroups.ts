 ...
 *
 * `playback.auto_skip_intro` is superseded by the three-way mode. The server
 * mirrors it for older clients, but rendering both controls here would let one
 * visible choice silently rewrite the other.
 */
